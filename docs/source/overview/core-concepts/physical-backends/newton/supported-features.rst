...
``IsaacContrib-UR10-Particle-Push-Direct`` use this fixed-Newton pattern and should be launched
...
* Coupled MPM manipulation: UR10 particle push (MJWarp + MPM)
...
* Coupled MPM manipulation: Franka pour (MJWarp + MPM)
