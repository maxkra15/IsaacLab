        ...
        if not cls._clone_physics_only:
            ...
            if not body_paths:
                ...
                for i, prim_path in enumerate(body_paths):
                    ...
                    if not prim.IsValid():
                        # Some Newton bodies are generated by builder hooks and have
                        # no authored USD prim. Examples include cable segment
                        # bodies, whose visible asset is the authored BasisCurves
                        # prim updated by the VBD curve sync.
                        continue
