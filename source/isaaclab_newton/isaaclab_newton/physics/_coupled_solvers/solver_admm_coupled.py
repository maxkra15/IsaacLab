...
if TYPE_CHECKING:
    from newton._src.sim import Contacts, Control, Model, ModelBuilder, State
...
class SolverAdmmCoupled(SolverCoupled):
    ...
    def register_custom_attributes(cls, builder: ModelBuilder) -> None:
        ...
        """
        from newton._src.sim import Model, ModelBuilder  # noqa: PLC0415
    ...
    def _setup_admm(self, coupling: SolverAdmmCoupled.Config) -> None:
        ...
        if self._admm_rigid_particle_contact_specs or self._admm_rigid_rigid_contact_specs:
            ...
            from newton._src.sim import CollisionPipeline  # noqa: PLC0415
