...
from .constants import BODY_FLAG_PROXY, PARTICLE_FLAG_ACTIVE, PARTICLE_FLAG_PROXY

if TYPE_CHECKING:
    from newton._src.sim import State
...
class ModelView:
    ...
    def state(self, requires_grad: bool | None = None) -> State:
        ...
        """
        from newton._src.sim import Model  # noqa: PLC0415
    ...
    def mark_proxy_bodies(self, body_indices: wp.array[int]) -> None:
        ...
        wp.launch(
            ...
            dim=body_indices.shape[0],
            inputs=[body_indices, BODY_FLAG_PROXY, body_flags],
            device=parent.device,
        )
    ...
    def mark_proxy_particles(self, particle_indices: wp.array[int]) -> None:
        ...
        wp.launch(
            ...
            inputs=[particle_indices, PARTICLE_FLAG_PROXY, particle_flags],
            device=parent.device,
        )
    ...
    def deactivate_particles(self, particle_indices: wp.array[int]) -> None:
        ...
        wp.launch(
            ...
            dim=particle_indices.shape[0],
            inputs=[particle_indices, PARTICLE_FLAG_ACTIVE, particle_flags],
            device=parent.device,
        )
