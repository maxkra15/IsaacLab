...
* Added eager fixed-capacity particle activation to
  :class:`~isaaclab_newton.assets.MPMObject` for variable-payload MPM tasks.
...
* Added explicit task-driven resets of solver-owned history on both active
