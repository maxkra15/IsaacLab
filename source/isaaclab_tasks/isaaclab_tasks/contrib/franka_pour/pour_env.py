...
class FrankaPourEnv(ManagerBasedRLEnv):
    ...
    def _collision_free_ik_candidates(
        ...
        segment_fractions = tuple(sample / 8.0 for sample in range(8))
    ...
    def _build_randomized_reset_bank(self) -> None:
        ...
        def local_prototype_builder() -> newton.ModelBuilder:
            ...
            source_builder = NewtonManager.get_clone_prototype_builder(source_path)
    ...
    def reset_pour_scene(self, env_ids: torch.Tensor) -> None:
        ...
        if grasp_rows.numel() > 0:
            ...
            reference_waypoints[grasp_rows, 3] = self._reach_grasp_arm_q_bank_t[bank_indices]
        ...
        if full_rows.numel() > 0:
            ...
            reference_waypoints[full_rows, 2] = self._reach_midgrasp_arm_q_bank_t[bank_indices]
            reference_waypoints[full_rows, 3] = self._reach_grasp_arm_q_bank_t[bank_indices]
        ...
        if randomized_rows.numel() > 0:
            ...
            bank_indices = sample_index_pools(
            ...
            reference_waypoints[randomized_rows, 2] = self._randomized_midgrasp_arm_q_bank_t[bank_indices]
            reference_waypoints[randomized_rows, 3] = self._randomized_grasp_arm_q_bank_t[bank_indices]
            reference_waypoints[randomized_rows, 4] = self._randomized_carry_arm_q_bank_t[bank_indices]
            reference_waypoints[randomized_rows, 5] = self._randomized_pour_arm_q_bank_t[bank_indices]
            reference_waypoints[randomized_rows, 6] = self._randomized_tilt_arm_q_bank_t[bank_indices]
