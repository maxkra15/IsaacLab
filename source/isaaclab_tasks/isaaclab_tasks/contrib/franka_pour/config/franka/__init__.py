...
gym.register(
    id="Isaac-Pour-Franka-Reset-Mixture-v0",
    entry_point=_ENV,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{_CFG}:FrankaPourEnvCfg_RESET_MIXTURE",
        "rsl_rl_cfg_entry_point": _RESET_MIXTURE_AGENT,
    },
)

gym.register(
    id="Isaac-Pour-Franka-Reset-Mixture-Eval-v0",
    entry_point=_ENV,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{_CFG}:FrankaPourEnvCfg_RESET_MIXTURE_EVAL",
        "rsl_rl_cfg_entry_point": _RESET_MIXTURE_AGENT,
    },
)

gym.register(
    id="Isaac-Pour-Franka-Reset-Mixture-Play-v0",
    entry_point=_ENV,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{_CFG}:FrankaPourEnvCfg_RESET_MIXTURE_PLAY",
        "rsl_rl_cfg_entry_point": _RESET_MIXTURE_AGENT,
    },
)
