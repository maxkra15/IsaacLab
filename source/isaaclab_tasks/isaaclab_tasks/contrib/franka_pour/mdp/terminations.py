...
def nonterminating_stable_pour_success(
    ...
    """Track stable success without ending live fixed-horizon training episodes."""
    ...
    # Record/replay removes the managed success term before invoking its configured callable.
    # Return the real predicate in that context and suppress only the live done signal.
