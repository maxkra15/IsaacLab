...
def _build_reset_dataset(cfg: FrankaPourResetDatasetEnvCfg) -> dict:
    ...
    local_position = torch.from_numpy(cup_cavity_lattice(cfg)[0]).unsqueeze(0)
    payload = {
    ...
    *,
    ...
    for world in range(2):
        ...
        expected_shapes = (
            ...
            ("SourceCup", "/SourceCup/ParticleCollider", False, True, False, mpm_collider_margin),
            ("TargetCup", "/TargetCup/ParticleCollider", False, True, False, mpm_collider_margin),
            ("TargetCup", "/TargetCup/Collision", True, False, False, rigid_contact_margin),
